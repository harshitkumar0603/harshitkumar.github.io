...
var FliktraxService = /** @class */ (function () {
    ...
    FliktraxService.prototype.getTracks = function () {
        ...
        var response = this.httpClient.get('http://api.fliktrax.com/search?searchterm=Hip%20Hop', { headers: headers })
            .map(function (list) { return list._embedded.search; });
        return response;
    };
    ...
    FliktraxService.prototype.getTracksByCategory = function (genre) {
        ...
        headers = headers.append('Authorization', 'Basic ' + btoa('audiotram:TSEBaY7q'));
        headers = headers.append('Content-Type', 'application/x-www-form-urlencoded');
        var response = this.httpClient.get('http://api.fliktrax.com/search?searchterm=' + genre, { headers: headers })
            .map(function (list) { return list._embedded.search; });
        return response;
    };
